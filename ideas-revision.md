...
- [x] **Tests:** cubiertos en `tests/` (bun:test): storage y APIs con mocks, acciones, presentación y utilidades.
...
- [x] ¿Hicieron el testing? Sí: storage, APIs con mocks de fetch, acciones, menú y utilidades.
