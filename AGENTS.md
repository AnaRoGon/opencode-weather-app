...
- Weather flow (see README examples): 1) geocode city via `geocoding-api.open-meteo.com/v1/search`, 2) fetch forecast via `api.open-meteo.com/v1/forecast?latitude=...&longitude=...`.
